...
{
    [Overlay(typeof(SceneView), "Transform Animator")]
    public class TransformAnimatorOverlay : ComponentOverlay<TransformAnimator>
    {
        ...
        public override VisualElement CreatePanelContent()
        {
            ...
            _slider = new Slider(0f, target.Duration) { enabledSelf = false };
        ...
        private void UpdateSliderState()
        {
            ...
            _slider.SetValueWithoutNotify(target.Time);
        }
    }
}